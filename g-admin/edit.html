...
<head>
	...
	<script type="text/javascript" src="js/lib/showdown.js"></script>
		<script type="text/javascript" src="js/lib/extensions/twitter.js"></script>
		<script type="text/javascript" src="js/lib/extensions/table.js"></script>
	...
	<!-- This is the question mark's function; Remove at your own risk -->
	<script type="text/javascript" src="js/markdown-help.js"></script>
</head>
<body>
	...
	<div class="grid full-height pad-top">
		<div id="posts-edit" class="col-1-2 full-height post-edit">
			<div class="content full-height">
				...
				<span class="right">
					<a href="help.php" target="_blank"><i id="help" class="icon-question-sign" title="Help"></i></a>
